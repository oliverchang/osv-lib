...
import (
	...
	"github.com/oliverchang/osv-lib/internal/url"
	"github.com/oliverchang/osv-lib/internal/utility/results"
	"github.com/oliverchang/osv-lib/internal/version"
...
func PrintSARIFReport(vulnResult *models.VulnerabilityResults, outputWriter io.Writer) error {
	...
	run := sarif.NewRunWithInformationURI("osv-scanner", "https://github.com/oliverchang/osv-lib")
